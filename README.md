...
7. Click **Upload** button to upload release.zip (created with `zip --exclude \*.git\* -r release.zip .`).
8. Select **lambda\_s3\_exec\_role** role (this function doesn't need access to any part of your AWS account)
